...
#define frameSize_EPD_EXT3_290 (uint32_t)(16128)
...
///
/// @brief Espressif ESP32S2-EPC
/// @note Numbers refer to GPIOs not pins
///
const pins_t boardESP32S2EPC =
{
    .panelBusy = EPD_BUSY, ///< EXT3 and EXT3-1 pin 3 Red -> GPIO27
    .panelDC = EPD_DC, ///< EXT3 and EXT3-1 pin 4 Orange -> GPIO26
    .panelReset = EPD_RESET, ///< EXT3 and EXT3-1 pin 5 Yellow -> GPIO25
    .flashCS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 8 Violet -> GPIO33
    .panelCS = EPD_SS, ///< EXT3 and EXT3-1 pin 9 Grey -> GPIO32
...
///
/// @brief Board used for PDLS_Viewer
/// @note Recommended board
///
const pins_t boardNone =
{
    ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V NOT_CONNECTED
    ///< EXT3 and EXT3-1 pin 2 Brown -> SPI SCK NOT_CONNECTED
    .panelBusy = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 3 Red -> NOT_CONNECTED
    .panelDC = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 4 Orange -> NOT_CONNECTED
    .panelReset = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 5 Yellow -> NOT_CONNECTED
    ///< EXT3 and EXT3-1 pin 6 Green -> SPI MISO NOT_CONNECTED
    ///< EXT3 and EXT3-1 pin 7 Blue -> SPI MOSI NOT_CONNECTED
    .flashCS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 8 Violet -> NOT_CONNECTED
    .panelCS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 9 Grey -> NOT_CONNECTED
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> NOT_CONNECTED
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> NOT_CONNECTED
    ///< EXT3 and EXT3-1 pin 10 White -> NOT_CONNECTED
    ///< EXT3-Touch pin 1 Brown -> I2C SDA NOT_CONNECTED
    ///< EXT3-Touch pin 2 Black -> I2C SCL NOT_CONNECTED
    .touchInt = NOT_CONNECTED, ///< EXT3-Touch pin 3 Red -> NOT_CONNECTED
    .touchReset = NOT_CONNECTED, ///< EXT3-Touch pin 4 Orange -> NOT_CONNECTED
    .panelPower = NOT_CONNECTED, ///< Optional power circuit NOT_CONNECTED
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board NOT_CONNECTED
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board NOT_CONNECTED
};
...
///
/// @brief Expander constants
/// @note b7 = 1 for expander ports numbers
/// @{
///
#define EXPANDER_P0 0x80 ///< port 0
#define EXPANDER_P1 0x81 ///< port 1
#define EXPANDER_P2 0x82 ///< port 2
#define EXPANDER_P3 0x83 ///< port 3
#define EXPANDER_P4 0x84 ///< port 4
#define EXPANDER_P5 0x85 ///< port 5
#define EXPANDER_P6 0x86 ///< port 6
#define EXPANDER_P7 0x87 ///< port 7
/// @}

///
/// @brief Texas Instruments LaunchPad with expander configuration, tested
///
const pins_t boardLaunchPadExpander =
{
    .panelBusy = 6, ///< EXT3 and EXT3-1 pin 3 Red
    .panelDC = EXPANDER_P0, ///< EXT3 and EXT3-1 pin 4 Orange
    .panelReset = EXPANDER_P1, ///< EXT3 and EXT3-1 pin 5 Yellow
    .flashCS = EXPANDER_P2, ///< EXT3 and EXT3-1 pin 8 Violet
    .panelCS = EXPANDER_P3, ///< EXT3 and EXT3-1 pin 9 Grey
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2
    .touchInt = 8, ///< EXT3-Touch pin 3 Red
    .touchReset = EXPANDER_P4, ///< EXT3-Touch pin 4 Orange
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
///
/// @brief Texas Instruments LaunchPad MSP5430FR5994 as GPU configuration, tested
///
const pins_t boardLaunchPadGPU =
{
    .panelBusy = 28, ///< EXT3 and EXT3-1 pin 3 Red
    .panelDC = 19, ///< EXT3 and EXT3-1 pin 4 Orange
    .panelReset = 30, ///< EXT3 and EXT3-1 pin 5 Yellow
    .flashCS = 18, ///< EXT3 and EXT3-1 pin 8 Violet
    .panelCS = 19, ///< EXT3 and EXT3-1 pin 9 Grey
    .panelCSS = 39, ///< EXT3 and EXT3-1 pin 12 Grey2
    .flashCSS = 38, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2
...
///
/// @brief Raspberry Pi Zero, 2B, 3B, 4B configuration with BCM2835, tested
/// @see https://www.airspayce.com/mikem/bcm2835/
/// @warning SPI pulls high GPIO8 CS0 pin 24 and GPIO7 CS1 pin 26.
/// @note BCM2835 library uses GPIO numbers, not pins numbers.
///
const pins_t boardRaspberryPiZeroB_BCM2835 =
{
    ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V pin 17
    ///< EXT3 and EXT3-1 pin 2 Brown -> SPI SCK pin 23
    .panelBusy = 25, ///< EXT3 and EXT3-1 pin 3 Red -> GPIO25 pin 22 RPI_BPLUS_GPIO_J8_22
    .panelDC = 24, ///< EXT3 and EXT3-1 pin 4 Orange -> GPIO24 pin 18 RPI_BPLUS_GPIO_J8_18
    .panelReset = 23, ///< EXT3 and EXT3-1 pin 5 Yellow -> GPIO23 pin 16 RPI_BPLUS_GPIO_J8_16
    ///< EXT3 and EXT3-1 pin 6 Green -> SPI MISO pin 21
    ///< EXT3 and EXT3-1 pin 7 Blue -> SPI MOSI pin 19
    .flashCS = 22, ///< EXT3 and EXT3-1 pin 8 Violet -> GPIO22 pin 15 RPI_BPLUS_GPIO_J8_15
    .panelCS = 27, ///< EXT3 and EXT3-1 pin 9 Grey -> GPIO27 pin 13 RPI_BPLUS_GPIO_J8_13
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> GPIO15 pin 10 RPI_BPLUS_GPIO_J8_10
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> GPIO18 pin 12 RPI_BPLUS_GPIO_J8_12
    ///< EXT3 and EXT3-1 pin 10 White -> GROUND pin 9
    ///< EXT3-Touch pin 1 Brown -> I2C SDA pin 3
    ///< EXT3-Touch pin 2 Black -> I2C SCL pin 5
    .touchInt = 4, ///< EXT3-Touch pin 3 Red -> GPIO4 pin 7 RPI_BPLUS_GPIO_J8_07
    .touchReset = 17, ///< EXT3-Touch pin 4 Orange -> GPIO17 pin 11 RPI_BPLUS_GPIO_J8_11
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
///
/// @brief Raspberry Pi Zero, 2B, 3B, 4B configuration with MRAA library, tested
/// @see https://mraa.io/
/// @note MRAA uses pins numbers, not GPIO numbers.
///
const pins_t boardRaspberryPiZeroB_MRAA =
{
    ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V pin 17
    ///< EXT3 and EXT3-1 pin 2 Brown -> SPI SCK pin 23
    .panelBusy = 22, ///< EXT3 and EXT3-1 pin 3 Red -> GPIO25 pin 22 RPI_BPLUS_GPIO_J8_22
    .panelDC = 18, ///< EXT3 and EXT3-1 pin 4 Orange -> GPIO24 pin 18 RPI_BPLUS_GPIO_J8_18
    .panelReset = 16, ///< EXT3 and EXT3-1 pin 5 Yellow -> GPIO23 pin 16 RPI_BPLUS_GPIO_J8_16
    ///< EXT3 and EXT3-1 pin 6 Green -> SPI MISO pin 21
    ///< EXT3 and EXT3-1 pin 7 Blue -> SPI MOSI pin 19
    .flashCS = 15, ///< EXT3 and EXT3-1 pin 8 Violet -> GPIO22 pin 15 RPI_BPLUS_GPIO_J8_15
    .panelCS = 13, ///< EXT3 and EXT3-1 pin 9 Grey -> GPIO27 pin 13 RPI_BPLUS_GPIO_J8_13
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> GPIO15 pin 10 RPI_BPLUS_GPIO_J8_10
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> GPIO18 pin 12 RPI_BPLUS_GPIO_J8_12
    ///< EXT3 and EXT3-1 pin 10 White -> GROUND pin 9
    ///< EXT3-Touch pin 1 Brown -> I2C SDA pin 3
    ///< EXT3-Touch pin 2 Black -> I2C SCL pin 5
    .touchInt = 7, ///< EXT3-Touch pin 3 Red -> GPIO4 pin 7 RPI_BPLUS_GPIO_J8_07
    .touchReset = 11, ///< EXT3-Touch pin 4 Orange -> GPIO17 pin 11 RPI_BPLUS_GPIO_J8_11
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
/*
///
/// @brief BeagleBone Black configuration with MRAA library, NOT tested
/// @see https://mraa.io/
/// @note MRAA uses pins numbers, not GPIO numbers.
///
const pins_t boardBeagleBone_MRAA =
{
    ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V port 9 pin 3
    ///< EXT3 and EXT3-1 pin 2 Brown -> SP1-SCK port 9 pin 31
    .panelBusy = BUILD_PIN(P8, 27), ///< EXT3 and EXT3-1 pin 3 Red -> port 9 pin 27
    .panelDC = BUILD_PIN(P8, 25), ///< EXT3 and EXT3-1 pin 4 Orange -> port 9 pin 25
    .panelReset = BUILD_PIN(P8, 23), ///< EXT3 and EXT3-1 pin 5 Yellow -> port 9 pin 23
    .flashCS = BUILD_PIN(P8, 41), ///< EXT3 and EXT3-1 pin 8 Violet -> port 9 pin 41
     ///< EXT3 and EXT3-1 pin 6 Green -> SPI1-D0 MISO pin 21port 9 pin 29
     ///< EXT3 and EXT3-1 pin 7 Blue -> SPI1-D0 MOSI port 9 pin 30
    .panelCS = BUILD_PIN(P8, 42), ///< EXT3 and EXT3-1 pin 9 Grey -> port 9 pin 42
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> port 9 pin
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> port 9 pin
     ///< EXT3 and EXT3-1 pin 10 White -> GROUND port 9 pin
     ///< EXT3-Touch pin 1 Brown -> I2C1-SDA port 9 pin
     ///< EXT3-Touch pin 2 Black -> I2C1-SCL port 9 pin
    .touchInt = BUILD_PIN(P8, 15), ///< EXT3-Touch pin 3 Red -> port 9 pin 15
    .touchReset = BUILD_PIN(P8, 12), ///< EXT3-Touch pin 4 Orange -> port 9 pin 12
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
///
/// @brief Adafruit Feather RP2040 configuration, tested
/// @warning Specific I²C port with #define hV_HAL_Wire Wire1
///
const pins_t boardFeatherRP2040 =
{
    ...
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2
    .touchInt = 7, ///< EXT3-Touch pin 3 Red -> D5 GPIO7
    .touchReset = 8, ///< EXT3-Touch pin 4 Orange -> D6 GPIO8
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
///
/// @brief Adafruit Huzzah ESP32 configuration, tested
/// @warning Specific I²C port with #define hV_HAL_Wire Wire1
///
const pins_t boardHuzzahESP32 =
{
    .panelBusy = 13, ///< EXT3 and EXT3-1 pin 3 Red -> D13 GPIO13
    .panelDC = 12, ///< EXT3 and EXT3-1 pin 4 Orange -> D12 GPIO12
    .panelReset = 27, ///< EXT3 and EXT3-1 pin 5 Yellow -> D11 GPIO27
    .flashCS = 33, ///< EXT3 and EXT3-1 pin 8 Violet -> D10 GPIO33
    .panelCS = 15, ///< EXT3 and EXT3-1 pin 9 Grey -> D9 GPIO15
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2
    .touchInt = 14, ///< EXT3-Touch pin 3 Red -> D5 GPIO14
    .touchReset = 32, ///< EXT3-Touch pin 4 Orange -> D6 GPIO32
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
const pins_t boardNucleo64 =
{
    ...
    .flashCS = 7, ///< EXT3 and EXT3-1 pin 8 Violet
    .panelCS = 8, ///< EXT3 and EXT3-1 pin 9 Grey
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> 9
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> 10
    .touchInt = 2, ///< EXT3-Touch pin 3 Red -> 2
    .touchReset = 3, ///< EXT3-Touch pin 4 Orange -> 3
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
/// @note Numbers refer to GPIOs not pins
/// @details For large / touch configurations
///
const pins_t boardXiaoRP2040
{
    .panelBusy = 26, ///< EXT3 and EXT3-1 pin 3 Red -> D0 GPIO26 / D0 GPIO26
    .panelDC = 27, ///< EXT3 and EXT3-1 pin 4 Orange -> D1 GPIO27 / D1 GPIO27
    .panelReset = 28, ///< EXT3 and EXT3-1 pin 5 Yellow -> D2 GPIO28 / D2 GPIO28
    .flashCS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 8 Violet -> D4 GPIO6 / D4 GPIO6
    .panelCS = 1, ///< EXT3 and EXT3-1 pin 9 Grey -> D3 GPIO29 / D7 GPIO1
    .panelCSS = NOT_CONNECTED, ///< EXT3 and EXT3-1 pin 12 Grey2 -> D5 GPIO7 / N/A
    .flashCSS = NOT_CONNECTED, ///< EXT3 pin 20 or EXT3-1 pin 11 Black2 -> N/A / N/A
    .touchInt = 0, ///< EXT3-Touch pin 4 Red -> N/A / D6 GPIO0
    .touchReset = 29, ///< EXT3-Touch pin 3 Orange -> N/A / D3 GPIO29
    .panelPower = NOT_CONNECTED, ///< Optional power circuit
    .cardCS = NOT_CONNECTED, ///< Separate SD-card board
    .cardDetect = NOT_CONNECTED, ///< Separate SD-card board
};
...
/// @note Numbers refer to GPIOs not pins
/// @warning Specific SPI port with SCK=8 MISO=9 MOSI=10
///
const pins_t boardXiaoESP32C3
{
    ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V
    ///< EXT3 and EXT3-1 pin 2 Brown -> SPI SCK GPIO8
    ...
    ///< EXT3 and EXT3-1 pin 6 Green -> SPI MISO GPIO9
    ///< EXT3 and EXT3-1 pin 7 Blue -> SPI MOSI GPIO10
    ...
    ///< EXT3 and EXT3-1 pin 10 White -> GROUND
    ///< EXT3-Touch pin 1 Brown -> I2C SDA GPIO6
    ///< EXT3-Touch pin 2 Black -> I2C SCL GPIO7
