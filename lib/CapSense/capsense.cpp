...
//static const touch_pad_t button[TOUCH_BUTTON_NUM] = {T2,T3,T4,T5};
...
////        .noise_thr = 3,         // 50%
////        .jitter_step = 2,       // use for jitter mode.
...
static void touch_button_read_task(void *pvParameter)
{
//    touch_event_t evt = {};
...
//    for (int i = 0; i < TOUCH_BUTTON_NUM; i++) {
//        touch_pad_set_cnt_mode((touch_pad_t)i, TOUCH_PAD_SLOPE_DEFAULT, TOUCH_PAD_TIE_OPT_DEFAULT);
//    }
//#endif
//
...
//
//    /* Filter setting */
//    touchsensor_filter_set(TOUCH_PAD_FILTER_IIR_4);
...
//    xTaskCreate(&touch_button_read_task, "touch_pad_read_task", 2048*2, NULL, TASK_PRIORITY_tOUCH, NULL);
}